...
const filterOptions = {
  role: ['Semua Role', 'Koor Cabang', 'Koor Koja'],
  cabang: ['Semua Cabang', 'Jakarta', 'Bekasi'],
...
const handleExport = () => {
  Swal.fire({
    icon: 'success',
    title: 'Berhasil!',
    text: 'Data koordinator sedang disiapkan untuk diunduh.',
...
<template>
  <div class="d-flex flex-nowrap align-items-center gap-2 filter-container">
    ...
    <CFormSelect
      ...
      @change="updateFilter('cabang', $event.target.value)"
